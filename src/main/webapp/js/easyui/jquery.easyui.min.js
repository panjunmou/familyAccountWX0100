...
(function ($) {
    ...
    $.messager = {
        show: function (_2b1) {
            ...
            return dlg;
        }, confirmSelect: function (_2b4, msg,options,fn) {
            var optionStr = "";
            if(options != null && options!= "" && options != undefined){
                optionStr += "<select name='confirmSelectName' style='margin-left: 40px;width:150px'>";
            ...
            var opts = typeof _2b4 == "object" ? _2b4 : {title: _2b4, msg: msg, fn: fn};
            opts = $.extend({}, $.messager.defaults, {content: "<div class=\"messager-icon messager-question\"></div>" + "<div>" + opts.msg + "</div>" + "<br/>" + "<div style=\"clear:both;\"/>" + "<div>"+optionStr+"</div>"}, opts);
            if (!opts.buttons) {
                opts.buttons = [{
                    text: opts.ok, onClick: function () {
                        _2af(dlg, dlg.find("select").val());
                    }
                }, {
                    text: opts.cancel, onClick: function () {
                        _2af(dlg);
...
(function ($) {
    ...
    function _65a(_72a, _72b, cb) {
        ...
        if (opts.pagination) {
            $.extend(_72c, {page: opts.pageNumber || 1, pageSize: opts.pageSize});
        }
        if (opts.sortName) {
...
(function ($) {
    ...
    function _872(_892, _893, _894, _895, _896) {
        ...
        if (opts.pagination) {
            $.extend(_897, {page: opts.pageNumber, pageSize: opts.pageSize});
        }
        if (opts.sortName) {
